...
function save_model(path::AbstractString, fitted::FittedGraph)
    any(node -> node isa Union{FittedSelect,FittedParallel,FittedConcatenate,
                               FittedColumnMap,FittedDecomposition,FittedNMF,
                               FittedRandomProjection,FittedKMeans,
                               FittedFastICA,
                               ...
                               FittedSGDClassifier,FittedSGDRegressor,
                               FittedMARSRegressor,
                               FittedPartialLeastSquares,
                               FittedGaussianMixture,FittedNearestNeighbors,FittedDBSCAN,
